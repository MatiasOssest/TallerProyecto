# Generated by Django 3.2.4 on 2021-06-03 21:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genero', models.CharField(blank=True, choices=[('Masculino', 'Masculino'), ('Femenino', 'Femenino'), ('Otro', 'Otro'), ('Prefieron no decir', 'No Info')], max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empleado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Retiro', to='empleados.empleado')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empleado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Historial_Servicio', to='empleados.empleado')),
            ],
        ),
        migrations.CreateModel(
            name='Educacion',
            fields=[
                ...
                ('anho', models.CharField(blank=True, max_length=255, null=True)),
                ('empeado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Educacion', to='empleados.empleado')),
            ],
        ),
        migrations.CreateModel(
            name='Dias_libres',
            fields=[
                ...
                ('fecha_inicio', models.DateField(blank=True, null=True)),
                ('fecha_termino', models.DateField(blank=True, null=True)),
                ('empleado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Dias_libres', to='empleados.empleado')),
            ],
        ),
        migrations.CreateModel(
            name='Capacitacion',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('titulo_capacitacion', models.CharField(blank=True, max_length=255, null=True)),
                ('institucion', models.CharField(blank=True, max_length=255, null=True)),
                ('fecha_inicio', models.DateField(blank=True, null=True)),
                ('fecha_termino', models.DateField(blank=True, null=True)),
                ('tipo_capacitacion', models.CharField(blank=True, max_length=255, null=True)),
                ('empleado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Capacitacion', to='empleados.empleado')),
            ],
        ),
        migrations.CreateModel(
            name='Ascenso',
            fields=[
                ...
                ('puesto', models.CharField(blank=True, max_length=255, null=True)),
                ('escala_pago', models.CharField(blank=True, max_length=255, null=True)),
                ('empleado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Ascenso', to='empleados.empleado')),
            ],
        ),
        migrations.CreateModel(
            name='Accion_Disciplinaria',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('comentario', models.CharField(blank=True, max_length=255, null=True)),
                ('sancion', models.CharField(blank=True, max_length=255, null=True)),
                ('fecha', models.DateField(blank=True, null=True)),
                ('empleado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Accion_Disciplinaria', to='empleados.empleado')),
            ],
        ),
    ]
